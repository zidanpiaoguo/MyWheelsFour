package com.example.lzy.sdk.views;
 ...
 *       圆点高度：  app:ci_height
 *       圆点的间距： app:ci_margin
 *       圆点选中状态： app:ci_drawable
 *       圆点未选中状态：app:ci_drawable_unselected
 *       圆点动画： app:ci_animator
 *       圆点反面动画： app:ci_animator_reverse
 *       圆点的摆放状态（默认水平）：app:ci_orientation (default:horizontal)
 *       原点的靠近状态（默认居中）： app:ci_gravity (default:center)
 *
 *
 *
 *      这个是别人的东西，作者忘了，github可以查得到。
 *
 *      可以直接依赖   compile 'me.relex:circleindicator:1.2.2@aar'
 *
 *
...
public class CircleIndicator extends LinearLayout {
    ...
    private int mIndicatorBackgroundResId = R.drawable.select_no_radius;
    private int mIndicatorUnselectedBackgroundResId = R.drawable.select_no_radius;
    ...
    public void configureIndicator(int indicatorWidth, int indicatorHeight, int indicatorMargin) {
        configureIndicator(indicatorWidth, indicatorHeight, indicatorMargin,
                R.animator.scale_with_alpha, 0, R.drawable.select_no_radius, R.drawable.select_no_radius);
    }
    ...
    private void checkIndicatorConfig(Context context) {
        ...
        mIndicatorBackgroundResId = (mIndicatorBackgroundResId == 0) ? R.drawable.select_no_radius
                : mIndicatorBackgroundResId;
        mIndicatorUnselectedBackgroundResId =
