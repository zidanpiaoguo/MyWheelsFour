package com.example.lzy.sdk.utils.security;
...
public class DESUtils {
    ...
    public static JSONObject encryptDES(String encryptString) {
        ...
        try {
            ...
            Cipher cipher = Cipher.getInstance("DESUtils/CBC/PKCS5Padding");
            //创建一个 DESKeySpec 对象，使用 8 个字节的key作为 DESUtils 密钥的密钥内容。
    ...
    public static String decryptDES(String decodeString)  {
        try {
            ...
            SecretKeySpec skeySpec = new SecretKeySpec(decodeKey.getBytes(), "DESUtils");
            //返回实现指定转换的 Cipher 对象
            Cipher cipher = Cipher.getInstance("DESUtils/CBC/PKCS5Padding");
            //解密初始化
